...
import middlewares, { isAdmin, validateBody, validateParams } from '../middlewares/user.middleware.js';
...
router.delete('/:uid', isAdmin, validateParams(['uid']), controller.remove);
